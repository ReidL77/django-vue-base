...
SECRET_KEY = 'django-insecure-5m9#3-5*g#t8g1n!x7gpu&o4+m-x%@m47)99&_g_kxy__9a^=^'
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:8081',  # Add the URL of your Vue frontend
]

# If you need to allow credentials (e.g., cookies, sessions), set this to True
